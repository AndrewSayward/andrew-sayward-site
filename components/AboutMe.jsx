...
const AboutMe = () => {
  return (
    <div className="container py-12">
      <div className="flex flex-wrap pt-20 lg:pt-40">
        <div className="w-full lg:w-4/12 relative prof-pic from-left">
          <Image 
            src={profilePic} 
            layout="fill"
            objectFit="cover"
        ...
        <div className="w-full lg:w-8/12 lg:pl-40 pt-20 lg:pt-0 from-right">
          ...
          <Link href="/portfolio">
            <div className="check-out font-bold text-3xl lg:text-4xl mt-24 cursor-pointer">Check out my work &gt;</div>
          </Link>
        </div>
      </div>
    </div>
